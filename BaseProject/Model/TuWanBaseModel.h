...
@class TuWanDataModel,TuWanDataIndexpicModel,TuWanDataIndexpicInfochildModel,TuWanDataShowitemModel,TuWanDataShowitemInfoModel;
...
@interface TuWanDataShowitemModel : BaseModel

@property (nonatomic, copy) NSString *pic;

@property (nonatomic, copy) NSString *text;

@property (nonatomic, strong) TuWanDataShowitemInfoModel *info;

@end

@interface TuWanDataShowitemInfoModel : BaseModel
